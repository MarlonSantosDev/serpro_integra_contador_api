  ...
  List<ServiceItem> get _services {
    final services = [
      ...
      ServiceItem(
        id: 'pgmei',
        name: 'PGMEI',
        description: 'Pagamento de DAS do MEI',
        icon: Icons.payment,
        color: Colors.green,
      ),
      ServiceItem(
      ...
      ServiceItem(
        id: 'sitfis',
        name: 'SITFIS',
        description: 'Sistema de Informações Tributárias Fiscais',
        icon: Icons.info,
        color: Colors.cyan,
      ),
      ServiceItem(
        id: 'sicalc',
        name: 'SICALC',
        description: 'Sistema de Cálculo de Impostos',
      ...
      ServiceItem(
        id: 'parcmei',
        name: 'PARCMEI',
        description: 'Parcelamento do MEI',
      ...
      ServiceItem(
        id: 'pertmei',
        name: 'PERTMEI',
        description: 'Pertinência do MEI',
      ...
      ServiceItem(
        id: 'relpmei',
        name: 'RELPMEI',
        description: 'Relatório de Pagamentos do MEI',
        icon: Icons.receipt,
      ...
      ServiceItem(
        id: 'parcsn',
        name: 'PARCSN',
        description: 'Parcelamento do Simples Nacional',
      ...
      ServiceItem(
        id: 'pertsn',
        name: 'PERTSN',
        description: 'Pertinência do Simples Nacional',
        icon: Icons.verified,
        color: Colors.lime,
      ),
      ServiceItem(
      ...
      ServiceItem(
        id: 'procuracoes',
        name: 'Procurações',
        description: 'Gestão de procurações eletrônicas',
        icon: Icons.gavel,
        color: Colors.grey,
      ),
      ServiceItem(
            ...
            onTap: () {
              if (!AuthService.isAuthenticated) {
                ScaffoldMessenger.of(context).showSnackBar(
                  const SnackBar(
                    content: Text(
                      'Por favor, configure a autenticação primeiro',
                    ),
