...
class ConsultarDadosCcmeiResponse {
  ...
  factory ConsultarDadosCcmeiResponse.fromJson(Map<String, dynamic> json) {
    return ConsultarDadosCcmeiResponse(status: int.parse(json['status'].toString()), mensagens: (json['mensagens'] as List).map((e) => MensagemCcmei.fromJson(e)).toList(), dados: ConsultarDadosCcmeiDados.fromJson(jsonDecode(json['dados'])));
  }
...
class ConsultarDadosCcmeiDados {
  ...
  factory ConsultarDadosCcmeiDados.fromJson(Map<String, dynamic> json) {
    return ConsultarDadosCcmeiDados(cnpj: json['cnpj'].toString(), empresario: Empresario.fromJson(json['empresario']), dataInicioAtividades: json['dataInicioAtividades'].toString(), nomeEmpresarial: json['nomeEmpresarial'].toString(), capitalSocial: double.parse(json['capitalSocial'].toString()), situacaoCadastralVigente: json['situacaoCadastralVigente'].toString(), dataInicioSituacaoCadastral: json['dataInicioSituacaoCadastral'].toString(), enderecoComercial: EnderecoComercial.fromJson(json['enderecoComercial']), enquadramento: Enquadramento.fromJson(json['enquadramento']), atividade: Atividade.fromJson(json['atividade']), termoCienciaDispensa: TermoCienciaDispensa.fromJson(json['termoCienciaDispensa']), qrcode: json['qrcode']?.toString());
  }
...
class EnderecoComercial {
  ...
  EnderecoComercial({required this.cep, this.logradouro, required this.numero, this.complemento, required this.bairro, required this.municipio, required this.uf});

  factory EnderecoComercial.fromJson(Map<String, dynamic> json) {
    return EnderecoComercial(cep: json['cep'].toString(), logradouro: json['logradouro']?.toString(), numero: json['numero'].toString(), complemento: json['complemento']?.toString(), bairro: json['bairro'].toString(), municipio: json['municipio'].toString(), uf: json['uf'].toString());
  }
...
class Enquadramento {
  ...
  factory Enquadramento.fromJson(Map<String, dynamic> json) {
    return Enquadramento(periodosMei: (json['periodosMei'] as List).map((e) => PeriodosMei.fromJson(e)).toList(), situacao: json['situacao'].toString(), optanteMei: json['optanteMei']);
  }
...
class Atividade {
  ...
  factory Atividade.fromJson(Map<String, dynamic> json) {
    return Atividade(formasAtuacao: (json['formasAtuacao'] as List).map((e) => e.toString()).toList(), ocupacaoPrincipal: Ocupacao.fromJson(json['ocupacaoPrincipal']), ocupacoesSecundarias: (json['ocupacoesSecundarias'] as List).map((e) => Ocupacao.fromJson(e)).toList(), optanteMei: json['optanteMei'] ?? false);
  }
...
class Ocupacao {
  ...
  factory Ocupacao.fromJson(Map<String, dynamic> json) {
    return Ocupacao(descricaoOcupacao: json['descricaoOcupacao'].toString(), codigoCNAE: json['codigoCNAE']?.toString(), descricaoCNAE: json['descricaoCNAE']?.toString());
  }
