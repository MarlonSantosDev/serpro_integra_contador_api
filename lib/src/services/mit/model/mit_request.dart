  ...
  void _validarCampos() {
    ...
    if (listaEventosEspeciais != null) {
      ...
      for (int i = 0; i < ids.length; i++) {
        if (ids[i] != i + 1) {
          throw ArgumentError(
            'Os valores de IdEvento devem ser uma sequência numérica começando em 1',
          );
        }
      }
    }
...
class Creditos {
  ...
  final ListaCreditosContribuicaoConcursoPrognosticos?
  ...
  Map<String, dynamic> toJson() {
    ...
    if (creditosContribuicaoConcursoPrognosticos != null) {
      dados['CreditosContribuicaoConcursoPrognosticos'] =
          creditosContribuicaoConcursoPrognosticos!.toJson();
    }
    ...
    if (creditosRetPagamentoUnificado != null) {
      dados['CreditosRetPagamentoUnificado'] = creditosRetPagamentoUnificado!
          .toJson();
    }

    if (creditosContribuicoesDiversas != null) {
      dados['CreditosContribuicoesDiversas'] = creditosContribuicoesDiversas!
          .toJson();
    }
...
class ListaCreditosContribuicaoConcursoPrognosticos
    implements ListaCreditosBase {
  @override
  final List<Credito> listaCreditos;
