...
class ExcecaoAssinaturaCertificado extends ExcecaoAutenticaProcurador {
  ...
  ExcecaoAssinaturaCertificado(
    ...
    String? codigo,
    this.diagnostico,
  }) : super(codigo: codigo ?? 'ERRO_CERTIFICADO', statusHttp: 400);
...
class ExcecaoAssinaturaXml extends ExcecaoAutenticaProcurador {
  ExcecaoAssinaturaXml(super.mensagem, {String? codigo})
    : super(codigo: codigo ?? 'ERRO_ASSINATURA_XML', statusHttp: 400);
}

/// Exceções relacionadas à validação ICP-Brasil
class ExcecaoValidacaoICPBrasil extends ExcecaoAutenticaProcurador {
  ExcecaoValidacaoICPBrasil(super.mensagem, {String? codigo})
    : super(codigo: codigo ?? 'ERRO_VALIDACAO_ICP', statusHttp: 403);
}

/// Mapeia erros específicos da API SERPRO
class ExcecaoErroSerpro extends ExcecaoAutenticaProcurador {
  ExcecaoErroSerpro(super.mensagem, {required super.codigo, super.statusHttp})
    : super();
