...
import 'package:serpro_integra_contador_api/src/models/parcsn/consultar_pedidos_response.dart';
import 'package:serpro_integra_contador_api/src/models/parcsn/consultar_parcelamento_response.dart';
import 'package:serpro_integra_contador_api/src/models/parcsn/consultar_detalhes_pagamento_response.dart';
import 'package:serpro_integra_contador_api/src/models/parcsn/consultar_parcelas_response.dart';
import 'package:serpro_integra_contador_api/src/models/parcsn/emitir_das_response.dart';
import 'package:serpro_integra_contador_api/src/models/parcsn/parcsn_validations.dart';
import 'package:serpro_integra_contador_api/src/models/parcsn/parcsn_errors.dart';
...
class ParcsnService {
  ...
  Future<EmitirDasResponse> emitirDas(int parcelaParaEmitir) async {
    ...
    final response = await _apiClient.post('/parcsn/Emitir', request);
