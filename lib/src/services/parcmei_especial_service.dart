...
import 'package:serpro_integra_contador_api/src/models/parcmei_especial/consultar_pedidos_response.dart';
import 'package:serpro_integra_contador_api/src/models/parcmei_especial/consultar_parcelamento_response.dart';
import 'package:serpro_integra_contador_api/src/models/parcmei_especial/consultar_parcelas_response.dart';
import 'package:serpro_integra_contador_api/src/models/parcmei_especial/consultar_detalhes_pagamento_response.dart';
import 'package:serpro_integra_contador_api/src/models/parcmei_especial/emitir_das_response.dart';
import 'package:serpro_integra_contador_api/src/models/parcmei_especial/parcmei_especial_validations.dart';
import 'package:serpro_integra_contador_api/src/models/parcmei_especial/parcmei_especial_errors.dart';
...
class ParcmeiEspecialService {
  ...
  Future<ConsultarPedidosResponse> consultarPedidos() async {
    ...
    final response = await _apiClient.post('/integra-contador-trial/v1/Consultar', request);
  ...
  Future<EmitirDasResponse> emitirDas(int parcelaParaEmitir) async {
    ...
    final response = await _apiClient.post('/integra-contador-trial/v1/Emitir', request);
