...
class AutenticaProcuradorService {
  ...
  Future<TermoAutorizacaoResponse> _enviarParaAPI(
    ...
    try {
      ...
      final requestBody = {
        'contratante': {'numero': DocumentUtils.cleanDocumentNumber(contratanteNumero), 'tipo': DocumentUtils.detectDocumentType(contratanteNumero)},
        'autorPedidoDados': {
          'numero': DocumentUtils.cleanDocumentNumber(autorPedidoDadosNumero),
          'tipo': DocumentUtils.detectDocumentType(autorPedidoDadosNumero),
        },
        'contribuinte': {
          'numero': DocumentUtils.cleanDocumentNumber(contribuinteNumero),
          'tipo': DocumentUtils.detectDocumentType(contribuinteNumero),
        },
        'pedidoDados': {
