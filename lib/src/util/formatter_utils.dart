...
class FormatterUtils {
  ...
  static String formatCpf(String cpf) {
    final cleanCpf = DocumentUtils.cleanDocumentNumber(cpf);

    if (cleanCpf.length != DocumentUtils.tamanhoCpf) {
      throw ArgumentError('CPF deve ter ${DocumentUtils.tamanhoCpf} dígitos. Recebido: $cleanCpf');
    }
  ...
  static String formatCnpj(String cnpj) {
    final cleanCnpj = DocumentUtils.cleanDocumentNumber(cnpj);

    if (cleanCnpj.length != DocumentUtils.tamanhoCnpj) {
      throw ArgumentError('CNPJ deve ter ${DocumentUtils.tamanhoCnpj} dígitos. Recebido: $cleanCnpj');
    }
  ...
  static String formatDocument(String document) {
    final cleanDocument = DocumentUtils.cleanDocumentNumber(document);

    if (cleanDocument.length == DocumentUtils.tamanhoCpf) {
      return formatCpf(document);
    } else if (cleanDocument.length == DocumentUtils.tamanhoCnpj) {
