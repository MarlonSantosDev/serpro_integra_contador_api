...
class BaseRequest {
  ...
  Map<String, dynamic> toJsonWithAuth({
    ...
    return {
      'contratante': {'numero': ValidacoesUtils.cleanDocumentNumber(contratanteNumero), 'tipo': contratanteTipo},
      'autorPedidoDados': {'numero': ValidacoesUtils.cleanDocumentNumber(autorPedidoDadosNumero), 'tipo': autorPedidoDadosTipo},
      'contribuinte': {'numero': ValidacoesUtils.cleanDocumentNumber(contribuinteNumero), 'tipo': contribuinteTipo},
