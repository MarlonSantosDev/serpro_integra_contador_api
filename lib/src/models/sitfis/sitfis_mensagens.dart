...
class SitfisMensagemCodigos {
  ...
  static const Map<String, String> descricoes = {
    ...
    sucessoSC02: 'A emissão relatório de situação fiscal está em processamento.',
    ...
    erroER02: 'Erro ao solicitar o protocolo do relatório. Tente novamente mais tarde.',
    ...
    erroER05: 'Erro ao processar a requisição. Inicie uma nova solicitação /apoiar.',
  };
