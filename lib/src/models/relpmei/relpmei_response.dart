...
class ParcelaImpressao {
  ...
  factory ParcelaImpressao.fromJson(Map<String, dynamic> json) {
    return ParcelaImpressao(
      ...
      usuarioStatus: json['usuarioStatus']?.toString(),
      observacoesStatus: json['observacoesStatus']?.toString(),
      codigoImpressao: json['codigoImpressao']?.toString(),
      dataImpressao: json['dataImpressao']?.toString(),
      usuarioImpressao: json['usuarioImpressao']?.toString(),
    );
  }
...
class DetalhePagamento {
  ...
  factory DetalhePagamento.fromJson(Map<String, dynamic> json) {
    return DetalhePagamento(
      numeroPagamento: json['numeroPagamento']?.toString(),
      cpfCnpj: json['cpfCnpj']?.toString(),
      inscricaoEstadual: json['inscricaoEstadual']?.toString(),
      codigoReceita: json['codigoReceita']?.toString(),
      referencia: json['referencia']?.toString(),
      ...
      usuarioStatus: json['usuarioStatus']?.toString(),
      observacoesStatus: json['observacoesStatus']?.toString(),
      codigoAutorizacao: json['codigoAutorizacao']?.toString(),
      numeroTransacao: json['numeroTransacao']?.toString(),
      dataTransacao: json['dataTransacao']?.toString(),
      horaTransacao: json['horaTransacao']?.toString(),
      valorTransacao: json['valorTransacao']?.toString(),
      formaPagamentoTransacao: json['formaPagamentoTransacao']?.toString(),
      bancoTransacao: json['bancoTransacao']?.toString(),
      agenciaTransacao: json['agenciaTransacao']?.toString(),
      contaTransacao: json['contaTransacao']?.toString(),
      numeroDocumentoTransacao: json['numeroDocumentoTransacao']?.toString(),
      dataEmissaoTransacao: json['dataEmissaoTransacao']?.toString(),
    );
  }
...
class Das {
  ...
  factory Das.fromJson(Map<String, dynamic> json) {
    return Das(
      ...
      dataImpressao: json['dataImpressao']?.toString(),
      usuarioImpressao: json['usuarioImpressao']?.toString(),
      arquivoDas: json['arquivoDas']?.toString(),
      tamanhoArquivo: json['tamanhoArquivo']?.toString(),
      tipoArquivo: json['tipoArquivo']?.toString(),
    );
  }
