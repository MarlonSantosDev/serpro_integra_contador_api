...
class HttpClientAdapter {
  ...
  Future<void> configureMtlsFromBytes(Uint8List certBytes, String certPassword) async {
    throw UnimplementedError('Utilize a implementação específica da plataforma.');
  }
  ...
  Future<Map<String, dynamic>> post(dynamic uri, Map<String, String> headers, String body) async {
    throw UnimplementedError('Utilize a implementação específica da plataforma.');
  }
  ...
  bool get isMtlsEnabled => throw UnimplementedError('Utilize a implementação específica da plataforma.');
}
