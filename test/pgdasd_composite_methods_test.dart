...
void main() {
  group('PGDASD Composite Methods - Type Validation', () {
    test(
      'ConsultarUltimaDeclaracaoComPagamentoResponse deve estender a classe base',
      () {
        // Arrange
        final baseResponse = ConsultarUltimaDeclaracaoResponse(
          status: 200,
          mensagens: [],
          dados: null,
        );
        ...
        // Act
        final compositeResponse =
            ConsultarUltimaDeclaracaoComPagamentoResponse.fromBase(
    ...
    test(
      'ConsultarUltimaDeclaracaoComPagamentoResponse.toJson deve incluir dasPago',
      () {
        // Arrange
        final response = ConsultarUltimaDeclaracaoComPagamentoResponse(
          status: 200,
          mensagens: [],
          dados: null,
          dasPago: false,
    ...
    test(
      'EntregarDeclaracaoComDasResponse deve ter getters corretos - sucesso',
      () {
        // Arrange
        final response = EntregarDeclaracaoComDasResponse(
          status: 200,
          mensagens: [],
    ...
    test(
      'EntregarDeclaracaoComDasResponse deve ter getters corretos - erro',
      () {
        // Arrange
        final response = EntregarDeclaracaoComDasResponse(
          status: 500,
    ...
    test(
      'EntregarDeclaracaoComDasResponse.toJson deve incluir todos os campos',
      () {
        // Arrange
        final response = EntregarDeclaracaoComDasResponse(
          status: 200,
    ...
    test(
      'PgdasdService deve ter método consultarUltimaDeclaracaoComPagamento',
      () {
        // Arrange
